...
public:
    ...
    //Interrupt logic
    uint8_t m_intMaster = true;
    uint8_t m_intEnable = 0x00;
    uint8_t m_intFlags = 0x00;
...
private:
    ...
    uint8_t _setBit(uint8_t mask, uint8_t operand);
    ...
    std::array<Instruction, 0x100> m_cbRom;
};
